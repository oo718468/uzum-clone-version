...
import elektr from "../photo/elektr.svg";
import Footer_menu from "./Footer_menu";

import { Slider, RangeSlider ,Checkbox,InputGroup,InputNumber, Footer } from 'rsuite';
...
function ReactDom() {
  ...
  return (
   ...
   <span id='one-two'>Электроника</span>
      ...
      <br />
        ...
        <div className='child_eletr_img'>
           <div className='card_item'>
             ...
             <Link to="/PhotoMenu"><img src={elektr} /></Link> 
                </div>
